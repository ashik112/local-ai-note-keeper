...
export const MIC_REQUIRES_HTTPS_MESSAGE =
  "The microphone needs a secure page (HTTPS). Browsers block it on plain HTTP when you open the app by LAN or public IP. Put the site behind HTTPS (for example Caddy or nginx with a certificate) or another HTTPS ingress you configure. Typed notes and Ask still work.";
